...
namespace KristofferStrube.Blazor.Streams
{
    ...
    /// </summary>
    public class TransformStreamDefaultController : BaseJSWrapper, IJSCreatable<TransformStreamDefaultController>
    {
        /// <summary>
        ...
        {
            return new TransformStreamDefaultController(jSRuntime, jSReference, new());
        }

        /// <inheritdoc/>
        public static async Task<TransformStreamDefaultController> CreateAsync(IJSRuntime jSRuntime, IJSObjectReference jSReference)
        {
            return await CreateAsync(jSRuntime, jSReference, new());
        }

        /// <inheritdoc/>
        public static Task<TransformStreamDefaultController> CreateAsync(IJSRuntime jSRuntime, IJSObjectReference jSReference, CreationOptions options)
        {
            return Task.FromResult(new TransformStreamDefaultController(jSRuntime, jSReference, options));
        }

        /// <inheritdoc cref="CreateAsync(IJSRuntime, IJSObjectReference, CreationOptions)"/>
        protected internal TransformStreamDefaultController(IJSRuntime jSRuntime, IJSObjectReference jSReference, CreationOptions options) : base(jSRuntime, jSReference, options) { }
