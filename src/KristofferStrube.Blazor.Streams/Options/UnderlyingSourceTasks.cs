...
/// </summary>
public class UnderlyingSourceTasks : IDisposable
{
    protected readonly Lazy<Task<IJSObjectReference>> helperTask;
    protected readonly IJSRuntime jSRuntime;

    /// <summary>
    /// Constructs a wrapper instance for a given JS Instance of a <see cref="UnderlyingSourceTasks"/>.
    /// </summary>
    /// <param name="jSRuntime">An <see cref="IJSRuntime"/> instance.</param>
    public UnderlyingSourceTasks(IJSRuntime jSRuntime)
    {
    ...
    public DotNetObjectReference<UnderlyingSourceTasks> ObjRef { get; init; }
